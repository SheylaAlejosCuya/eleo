    ...
    <div class="ui segment ten wide column">
        ...
        <div class="ui vertical segment">
            <div id="arrowContainer" class="ui three column grid">
                ...
                <div class="row">
                    <div class="column">
                        <div onClick="setSelectedImage(this)" id="1" class="ui segment" style="text-align: center">1927</div>
                    </div>
                ...
                <div class="row">
                    <div class="column">
                        <div onClick="setSelectedImage(this)" id="2" class="ui segment" style="text-align: center">1981 - 2000</div>
                    </div>
                    <div class="column"></div>
                    <div class="column">
                ...
                <div class="row">
                    <div class="column">
                        <div onClick="setSelectedImage(this)" id="3" class="ui segment" style="text-align: center">1951 - 1960</div>
                    </div>
                    <div class="column"></div>
                    <div class="column">
                ...
                <div class="row">
                    <div class="column">
                        <div onClick="setSelectedImage(this)" id="4" class="ui segment" style="text-align: center">1961 a 1970</div>
                    </div>
                    <div class="column"></div>
                    <div class="column">
                ...
                <div class="row">
                    <div class="column">
                        <div onClick="setSelectedImage(this)" id="5" class="ui segment" style="text-align: center">2014</div>
                    </div>
                    <div class="column"></div>
                    <div class="column">
                ...
                <div class="row">
                    <div class="column">
                        <div onClick="setSelectedImage(this)" id="6" class="ui segment" style="text-align: center">1941 - 1950</div>
                    </div>
                    <div class="column"></div>
                    <div class="column">
