        ...
        <div class="row text-center" >
            ...
            <div class="col-lg-4" style="background: white; height: 900px;  align-items: center;display: flex; justify-content: center;">
              <form  method="POST" action="{{route('api_login')}}" style="background: white; width: 320px;">
                ...
                <p style="font-size: 14px;">¿No cuentas con una cuenta? <font style="color:#8DC63F" >Regístrate ahora</font></p>
                ...
                <br>
                <input type="password" name='password' id='password' placeholder="contraseña" style="margin-top: 8%; margin-bottom: 11%; padding-left: 15px; border: none; border-bottom: 0.5px solid rgb(131, 123, 123); width: 100%;">
  
                <input type="submit" id="button_login" style="background: #8DC63F; border-radius: 10px; padding: 2%; width: 300px; color: white;">Iniciar sesión</a>
