<div class="actividadPreview">
    <div class="actividadPreview__top">
        ...
        <div class="actividadPreview__topRight">
            <button class="saveButton" data-toggle="modal" data-target="#asignar">Asignar</button>
        </div>
    </div>
    <div class="actividadePreview__bottom">
        <div class="actividadOptionRow profileInfoRow">
            <div class="profileTitle">Video</div>
            <button class="cancelButton" data-toggle="modal" data-target="#video">Previsualizar</button>
        </div>
        <div class="actividadOptionRow profileInfoRow">
            <div class="profileTitle">Escuchar Audio</div>
            <button class="cancelButton" data-toggle="modal" data-target="#audio">Previsualizar</button>
        </div>
        <div class="actividadOptionRow profileInfoRow">
            <div class="profileTitle">Visualizar Texto</div>
            <button class="cancelButton" data-toggle="modal" data-target="#texto">Previsualizar</button>
        </div>
        <div class="actividadOptionRow profileInfoRow">
            <div class="profileTitle">Actividad de Producción</div>
            <button class="cancelButton" data-toggle="modal" data-target="#produccion">Previsualizar</button>
        </div>
    </div>
    <div class="modal" id="asignar" tabindex="-1" aria-hidden="true">
        <div class="modalContainer">
            <div class="asignarContainer">
                ...
                <p data-dismiss="modal">Cerrar</p>
            </div>
        </div>
    </div>

    <div class="modal" id="video" tabindex="-1" aria-hidden="true">
        <div class="modalContainer">
            <div class="asignarContainer">
    ...
    <div class="modal" id="preguntas" tabindex="-1" aria-hidden="true">
        <div class="modalContainer">
            <div class="asignarContainer">
    ...
    <div class="modal" id="audio" tabindex="-1" aria-hidden="true">
        <div class="modalContainer">
            <div class="asignarContainer">
                <div style="position: relative">
    ...
    <div class="modal" id="opciones" tabindex="-1" aria-hidden="true">
        <div class="modalContainer">
    ...
    <div class="modal" id="texto" tabindex="-1" aria-hidden="true">
        <div class="modalContainer">
            <div class="asignarContainer">
                <div class="asignarModal">
                    <div class="nextButtonL">
    ...
    <div class="modal" id="produccion" tabindex="-1" aria-hidden="true">
        <div class="modalContainer">
            <div class="asignarContainer">
                <div class="asignarModal">
                    <div class="nextButtonL">
