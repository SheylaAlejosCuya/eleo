        ...
        try {
            ...
            if($pregunta) {
                ...
                if($pregunta->final_resource != null && $pregunta->final_resource != '') {
                    ...
                    $filename = 'actividad_'.$id_reading.'.docx';
                    $tempDoc = tempnam(sys_get_temp_dir(), $filename);
                    copy($pregunta->final_resource, $tempDoc);
                    return response()->download($tempDoc, $filename)->deleteFileAfterSend(true);
                }
            }
