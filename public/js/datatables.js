...
(function (k) {
    ...
    u.defaults = {
        ...
        oLanguage: {
            ...
            oPaginate: { sFirst: "Primero", sLast: "Final", sNext: "Siguiente", sPrevious: "Anterior" },
...
(function (a) {
                    ...
                    if (Array.isArray(g)) z(q, g);
                        ...
                        h &&
                            ((t = a("<" + t + ">", {
                                ...
                                id: 0 === B && "string" === typeof g ? f.sTableId + "_" + g : null,
                                href: "#",
    ...
    a(c).on("init.dt", function (f, l) {
        "dt" === f.namespace &&
            ...
            a.fn.dropdown && a("div.dataTables_length select", f.table().container()).dropdown(),
            a("div.dataTables_filter.ui.input", f.table().container()).removeClass("input").addClass("form"),
            a("div.dataTables_filter input", f.table().container()).wrap('<span class="ui input" />'));
    });
    return d;
});
